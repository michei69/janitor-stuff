...
declare type SettingsEndpoints = {
    ...
    api: {
        chat: {
            ...
            create: any,
            createComment: any,
            createMessages: ({data, urlParams}: {data: any, urlParams: {chatId: number|string}}) => Promise<ChatMessage[]>,
            delete: any,
            deleteComment: any,
            deleteMessages: any,
            fork: any,
            getComments: any,
            hiddenPublicChats: any,
            hidePublicChat: any,
            homepage: any,
            likeComment: any,
            listPublic: any,
            ...
            publishMine: any,
            react: any,
            unhidePublicChat: any,
            unlikeComment: any,
            unpublish: any,
            unreact: any,
            update: any,
            updateMessage: any,
            updateMessageRating: any,
            view: any,
            viewPublic: any,
        }
    },
...
declare type InputStore = {
    ...
    cancelEnhance: () => void,
    chatStore: ChatStore,
    closeAnonChatAuthModal: () => void,
    closeCommandPalette: () => void,
    closeCrisisReferral: () => void,
    ...
    openAnonChatAuthModal: () => void,
    openCommandPalette: () => void,
    openCrisisReferral: () => void,
...
declare type MessagesStore = {
    ...
    editMessage: (message: ChatMessage, newMessage: string) => Promise<void>,
